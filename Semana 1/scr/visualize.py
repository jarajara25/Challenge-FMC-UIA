...
if __name__ == '__main__':
    ...
    """
    # 配置路径
    data_root = '/content/drive/MyDrive/Challenge_China/train_mini_fixed'  # 数据根目录
    pred_root = '/content/drive/MyDrive/Challenge_China/predictions_new_new'  # 预测结果目录
    output_dir = '/content/drive/MyDrive/Challenge_China/visualizations/'      # 可视化输出目录
