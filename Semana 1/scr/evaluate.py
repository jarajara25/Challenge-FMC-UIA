...
class Evaluator:
    ...
    def __init__(self, data_root: str, pred_root: str):
        ...
        self.csv_path = os.path.join(self.data_root, '/content/drive/MyDrive/Challenge_China/train_mini_fixed/csv_files')
...
if __name__ == '__main__':
    ...
    """
    # Configure paths
    data_root = '/content/drive/MyDrive/Challenge_China/train_mini_fixed'
    pred_root = '/content/drive/MyDrive/Challenge_China/predictions_new_new'
    output_file = '/content/drive/MyDrive/Challenge_China/predictions_new_new/evaluation_results.json'
    summary_file = '/content/drive/MyDrive/Challenge_China/predictions_new_new/evaluation_summary.txt'
